...
def _shape_key_object_mode_context_menu(self, context):
	self.layout.operator(_shapekeys.OperatorApplyActive.bl_idname, icon='KEYINGSET')
...
def _selection_menu(self, context):
	...
	self.layout.operator(_attributes.OperatorSaveSelectionToAttribute.bl_idname, icon='SELECT_SET')
	self.layout.operator(_attributes.OperatorLoadSelectionFromAttribute.bl_idname, icon='SELECT_SET')
...
class _VIEW3D_MT_select_kawa_sub_menu(_bpy.types.Menu):
	bl_label = "Kawashirov"
...
def register():
	...
	_bpy.utils.register_class(_VIEW3D_MT_select_kawa_sub_menu)
	
	_bpy.types.VIEW3D_MT_object.append(_VIEW3D_MT_object_kawa_sub_menu_layout)
	_bpy.types.VIEW3D_MT_object_context_menu.append(_VIEW3D_MT_object_kawa_sub_menu_layout)
	
	_bpy.types.VIEW3D_MT_edit_mesh.append(_VIEW3D_MT_edit_mesh_kawa_sub_menu_layout)
	_bpy.types.VIEW3D_MT_edit_mesh_context_menu.append(_VIEW3D_MT_edit_mesh_kawa_sub_menu_layout)
	_bpy.types.VIEW3D_MT_edit_mesh_vertices.append(_VIEW3D_MT_edit_mesh_kawa_sub_menu_layout)
	
	# _bpy.types.VIEW3D_MT_select_object.append(_VIEW3D_MT_select_kawa_sub_menu_layout)
	_bpy.types.VIEW3D_MT_select_edit_mesh.append(_VIEW3D_MT_select_kawa_sub_menu_layout)
	
	_bpy.types.VIEW3D_MT_edit_armature.append(_VIEW3D_MT_edit_armature_kawa_sub_menu_layout)
	_bpy.types.VIEW3D_MT_pose.append(_VIEW3D_MT_edit_armature_kawa_sub_menu_layout)
...
def unregister():
	_bpy.types.VIEW3D_MT_object.remove(_VIEW3D_MT_object_kawa_sub_menu_layout)
	_bpy.types.VIEW3D_MT_object_context_menu.remove(_VIEW3D_MT_object_kawa_sub_menu_layout)
	
	_bpy.types.VIEW3D_MT_edit_mesh.append(_VIEW3D_MT_edit_mesh_kawa_sub_menu_layout)
	_bpy.types.VIEW3D_MT_edit_mesh_context_menu.remove(_VIEW3D_MT_edit_mesh_kawa_sub_menu_layout)
	_bpy.types.VIEW3D_MT_edit_mesh_vertices.remove(_VIEW3D_MT_edit_mesh_kawa_sub_menu_layout)
	
	# _bpy.types.VIEW3D_MT_select_object.remove(_VIEW3D_MT_select_kawa_sub_menu_layout)
	_bpy.types.VIEW3D_MT_select_edit_mesh.remove(_VIEW3D_MT_select_kawa_sub_menu_layout)
	...
	_bpy.utils.unregister_class(_VIEW3D_MT_select_kawa_sub_menu)
